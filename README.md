...
یکی از اصلی ترین دغدغه های برنامه نویسان برای یافتن شرکت مناسب، بی اطلاعی از تست ها و آزمون هایی ست که شرکت ها برای جذب
برنامه نویسان جدید از آنها میگیرند. هدف این ریپو صرفا، آشنایی با رویکرد ها و اهداف پروژه های تستی ست و قصد و نیت دیگری
را دنبال نمیکند.   
